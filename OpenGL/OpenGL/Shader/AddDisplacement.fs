...
FragColor=(texture(waveMap, -uv_use))*cos((uv.y-0.5)*PI)*Scale_control.x+texture(screen_RT,uv)*Scale_control.y+vec4(x_gerstner,y_gerstner,z_gerstner,0.0)*Scale_control.z;
