...
B_Spline::B_Spline(int count, int k, std::vector<glm::vec2> control_Point, std::vector<double> u_control)
{
	this->k = k;
	this->count = count;
...
double B_Spline::deBoor_Cox_iter(double u, int k, int i)
{
...
std::vector<glm::vec2> B_Spline::produce_height_array()
{	
	max_y = -1e12;
	min_y = 1e12;
	max_x = -1e12;
