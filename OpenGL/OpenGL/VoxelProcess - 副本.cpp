...
void VoxelProcess::Process()
{
    ...
    model1 = glm::translate(model, glm::vec3(ScaleUse.x, -ScaleUse.y+2.0, ScaleUse.z));
...
// tempScale = 0.04f;
  //tempScale = 0.8f;
   ...
   // model = glm::scale(model, glm::vec3(4.0f));
    ...
    model_inverse_t = glm::transpose(glm::inverse(model1));
  ...
  /*  CalculateDeltaTime();*/
    ...
    roomModel->UpdateBoundingBox(glm::mat3(1.0), glm::vec3(ScaleUse.x, -ScaleUse.y, ScaleUse.z), glm::vec3(0.5f), true);
   ...
   // CalculateDeltaTime();
    if (EnableVoxelization) 
    {
       ...
       //if(Time<2.0f)
        ...
        roomModel->Draw(*myshader_gs, rt, nullptr, voxel_rt, nullptr);
